...
def run_llm_inference(
    """
    Runs LLM inference with a given prompt and an optional system prompt.

    Args:
        prompt (str): The user prompt for the LLM.
        system_prompt (str, optional): The system instruction for the LLM. Defaults to 'You are a helpful AI assistant.'.
...
def run_llm_inference_with_grounding(
    """
    Runs LLM inference with a given prompt, an optional system prompt, and grounding sources.
    This function utilizes Google Search as a tool for grounding.
